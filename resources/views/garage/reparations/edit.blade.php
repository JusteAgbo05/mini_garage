...
@section('titre', 'Modifier la reparation')

@section('contenu')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="mb-0"><i class="bi bi-pencil me-2"></i>Modifier la reparation</h2>
                            ...
                            <div class="col-md-4">
                                <div class="form-check border rounded p-3">
                                    <input class="form-check-input" type="checkbox"
                                           ...
                                           {{ in_array($technicien->id, old('techniciens', $technicienIds)) ? 'checked' : '' }}>
